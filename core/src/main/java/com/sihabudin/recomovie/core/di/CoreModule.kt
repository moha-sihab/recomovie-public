package com.sihabudin.recomovie.core.di

import androidx.room.Room
import com.sihabudin.recomovie.core.BuildConfig
import com.sihabudin.recomovie.core.data.MovieRepository
import com.sihabudin.recomovie.core.data.source.local.LocalDataSource
import com.sihabudin.recomovie.core.data.source.local.room.MovieDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("sihabian".toCharArray())
        val factory = SupportFactory(passphrase)
        Room.databaseBuilder(
            androidContext(),
            MovieDatabase::class.java, "recomovie.db"
